...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">场地信息管理系统</font></h2>
		...
		<label class="radio inline">
			<input id="user" type="radio" name="userType" value="user"  ${userType==3?'checked':''}/> 普通用户
		</label>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn btn-large btn-primary" type="button" onclick="window.location.href='/signup.jsp'">注册</button>
        <p align="center" style="padding-top: 15px;">周琪丰 彭钧涛</p>
	  </form>
</div>
</body>
</html>