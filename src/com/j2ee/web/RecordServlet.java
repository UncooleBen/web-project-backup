...
import com.j2ee.dao.RecordDao;
import com.j2ee.dao.RecordFinalDao;
...
public class RecordServlet extends HttpServlet{
	...
	RecordFinalDao recordFinalDao = new RecordFinalDao();
    ...
    private void recordFinalSave(HttpServletRequest request,
                                 HttpServletResponse response)throws ServletException, IOException {
        HttpSession session = request.getSession();
        String recordId = request.getParameter("recordId");
        Record record = new Record();
        ...
        try {
            ...
            Statement stmt = con.createStatement();
            ResultSet rs;
            rs = stmt.executeQuery("select recordId, userNumber, userName, buildId, roomName, date, detail  from t_record");
            while (rs.next()) {
